...
- [Gate latency](docs/decisions/project_gate_latency.md) — 게이트 54분의 8할은 같은 산출물을 24번 빌드하는 비용이었다; clean을 1회로 옮겨 24분 09초가 됐고 빌드 스텝 검사로 구멍을 막았다, Zig는 touch를 무시하고 make는 따른다
